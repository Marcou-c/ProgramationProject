...
router.get('/', controller.getAllGraduates); // Obtener todos los graduados
router.get('/:id', controller.getGraduateById); // Obtener un graduado por ID
router.post('/', controller.createGraduate); // Crear un nuevo graduado (solo admin)
router.put('/:id', controller.updateGraduate); // Actualizar un graduado
router.delete('/:id',  controller.deleteGraduate); // Eliminar un graduado (solo admin)
